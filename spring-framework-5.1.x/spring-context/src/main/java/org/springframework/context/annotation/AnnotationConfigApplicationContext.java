...
public class AnnotationConfigApplicationContext extends GenericApplicationContext implements AnnotationConfigRegistry {
	...
	public AnnotationConfigApplicationContext() {
		/**
		 * reader.register(配置类、或某个类); 完成class-->beanDefinition的转变，并存放在beanDefinitionMap中
		 */
		this.reader = new AnnotatedBeanDefinitionReader(this);
		/**
		 * 扫描类，过滤掉不是spring bean的bd。当然，我们可以在此扩展，继承此类ClassPathBeanDefinitionScanner，然后重写其中的方法，或
		 * 增加我们自己的{@TypeFilter},实现让spring管理我们自定义的类，或特定的注解。mybatis的@MapperScan就是这样扩展的！！
		 */
